    ...
    var miniTheme = {
        ...
        config: function (bgcolorId) {
            var bgColorConfig = [{
                ...
                headerRightBgThis: '#ffffff', //头部右侧选中背景色,
                ...
                headerLogoBg: '#fff', //logo背景颜色,
                headerLogoColor: 'rgb(0,0,0)', //logo字体颜色,
                leftMenuNavMore: 'rgb(191, 187, 187)', //左侧菜单更多下拉样式,
                leftMenuBg: '#fff', //左侧菜单背景,
                leftMenuBgThis: '#fcfcfc', //左侧菜单选中背景,
                leftMenuChildBg: '#fcfcfc', //左侧菜单子菜单背景,
                leftMenuColor: 'rgb(0,0,0)', //左侧菜单字体颜色,
                leftMenuColorThis: '#2d8cf0', //左侧菜单选中字体颜色,
