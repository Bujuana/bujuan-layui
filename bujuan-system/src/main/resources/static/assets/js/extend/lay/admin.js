...
layui.define(["jquery", "layer", "element", "miniMenu", "miniTheme", "miniTab"], function (exports) {
    var $ = layui.$;
    ...
    var miniAdmin = {
        ...
        render: function (options) {
            ...
            $.post(options.initUrl, function (data) {
        ...
        renderAnim: function (anim) {
            if (anim) {
                ...
                `;
                $('#layuimini-bg-color').after(style);
            }
        },
